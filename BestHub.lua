...
local Window = Rayfield:CreateWindow({
   Name = "💪 Best Hub | Muscle Masters",
   LoadingTitle = "Best Hub Loader",
...
KeyTab:CreateButton({
   ...
   Callback = function()
      ...
      -- 🔑 VERIFICA DELLA NUOVA CHIAVE "BestHub-"
      if InputKeyData == "BestHub-" then
         HubUnlocked = true 
         
         Rayfield:Notify({
            Title = "🔑 KEY CORRECT!",
            Content = "Unlocking Best Hub... Please wait.",
            Duration = 3,
            Image = 4483362458,
         })
         ...
         SettingsTab:CreateButton({
            ...
            Callback = function()
               if CoreGui:FindFirstChild("BestHub_AntiAFK") then return end
               ...
               ScreenGui.Name = "BestHub_AntiAFK"
               ...
               DeactivateBtn.MouseButton1Click:Connect(function()
                   ...
                   if updateConnection then updateConnection:Disconnect() end
                   ScreenGui:Destroy()
                   Rayfield:Notify({Title = "Best Hub", Content = "Anti-AFK deactivated.", Duration = 3})
               end)
            end
         })

         -- Forzatura Refresh Grafico per Rayfield
         task.wait(0.1)
         FarmTab:Select()
